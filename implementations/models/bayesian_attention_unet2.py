...
class BayesianAttentionUNet(nn.Module):
    def __init__(self, n_channels, n_classes, dropout_rate=0.5):
        ...
        self.att1 = BAttentionBlock(1024, 512, 512, self.dropout_rate)
        self.up1 = BUp(1024, 512, self.dropout_rate)
        self.att2 = BAttentionBlock(512, 256, 256, self.dropout_rate)
        self.up2 = BUp(512, 256, self.dropout_rate)
        self.att3 = BAttentionBlock(256, 128, 128, self.dropout_rate)
        self.up3 = BUp(256, 128, self.dropout_rate)
        self.att4 = BAttentionBlock(128, 64, 64, self.dropout_rate)
